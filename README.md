...
- GitHub Release <sup>***`📦 Stable`***</sup>: 它是最新的稳定版本，如果不追求最新的功能，你可以使用这个版本 - [activator.sgmodule](https://github.com/wibus-wee/activation-script/releases/latest/download/activator.sgmodule)
